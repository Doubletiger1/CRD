...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [Conv, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, MixConv2d, Focus, CrossConv,
                 BottleneckCSP, C3, C3TR, C3SPP, C3Ghost,RepConv]:
            c1, c2 = ch[f], args[0]
            ...
            args = [ch[f]]
        elif m in [ConvNextv2_Attention]:
            c1, c2 = ch[f], args[0]
            if c2 != no:  # if not outputss
                c2 = make_divisible(c2 * gw, 8)
            args = [c1, c2, *args[1:]]
            if m in [ConvNextv2_Attention]:
                args.insert(2, n)  # number of repeats
                n = 1
        elif m is AsymptoticFPN:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='/home/ubuntu/haokun/dengzhihui/02otherprojects/24-defect-2400/yolov5-6.1_P-LSK-AFPN/models/improve/yolov5s-3-p_lsk_afpn.yaml', help='model.yaml')
