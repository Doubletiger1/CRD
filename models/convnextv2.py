...
#
#     Args:
#         in_chans (int): Number of input image chae for clnnels. Default: 3
#         num_classes (int): Number of classes for classification head. Default: 1000
#         depths (tuple(int)): Number of blocks at each stage. Default: [3, 3, 9, 3]
#         dims (int): Feature dimension at each stage mg. Default: [96, 192, 384, 768]
#         drop_path_rate (float): Stochastic depth rate. Default: 0.
#         head_init_scale (float): Init scaling valuassifier weights and biases. Default: 1.
#     """
...
class ConvNextv2_Attention(nn.Module): # ConvSE
